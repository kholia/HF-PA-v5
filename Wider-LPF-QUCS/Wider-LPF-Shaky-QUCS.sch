...
<Properties>
  <View=0,-300,906,900,1.94872,0,749>
  <Grid=10,10,1>
...
<Components>
  ...
  <L L1 1 440 260 -26 10 0 0 "300nH" 1 "" 0>
  <GND * 1 510 370 0 0 0 0>
  <L L2 1 580 260 -26 10 0 0 "300nH" 1 "" 0>
  <GND * 1 650 370 0 0 0 0>
  <Pac P2 1 760 340 18 -26 0 1 "2" 1 "50 Ohm" 1 "0 dBm" 0 "1 GHz" 0 "26.85" 0>
  <GND * 1 760 370 0 0 0 0>
  <.SP SP1 1 270 440 0 67 0 0 "log" 1 "3.3MHz" 1 "45MHz" 1 "512" 1 "no" 0 "1" 0 "2" 0 "no" 0 "no" 0>
  <Eqn Eqn1 1 490 450 -28 15 0 0 "dBS21=dB(S[2,1])" 1 "dBS11=dB(S[1,1])" 1 "yes" 0>
  <C C1 1 370 340 17 -26 0 1 "94pF" 1 "" 0 "neutral" 0>
  <C C2 1 510 340 17 -26 0 1 "190pF" 1 "" 0 "neutral" 0>
  <C C3 1 650 340 17 -26 0 1 "96pF" 1 "" 0 "neutral" 0>
</Components>
<Wires>
